...
import { useEditGenericService } from "@/services/api/services/generics";
...
function FormEdit() {
  ...
  const fetchEditGeneric = useEditGenericService();
  const { t } = useTranslation("admin-panel-generics-edit");
  const validationSchema = useValidationSchema();
  const { data: initialData } = useGetGenericQuery({ id: entityId });
