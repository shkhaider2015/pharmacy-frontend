...
import { useCreateCustomerService } from "@/services/api/services/customers";
...
function FormCreate() {
  ...
  const fetchCreateCustomer = useCreateCustomerService();
  const { t } = useTranslation("admin-panel-customers-create");
  ...
  const onSubmit = handleSubmit(async (formData) => {
    const { data, status } = await fetchCreateCustomer({
      name: formData.name,
